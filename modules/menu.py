    ...
    while True:
      ...
      if cmd=="1":
        ...
        if system.connection:
          ...
          logo.updating()
          if system.sudo != None:
            if os.path.exists(system.home+"/sparkz"):
              pass
            else:
              os.system(system.sudo+" git clone https://github.com/sparkz-technology/sparkz.git "+system.home+"/sparkz")
            if os.path.exists(system.home+"/sparkz/install.aex"):
              os.system("cd "+system.home+"/sparkz && "+system.sudo+" sh install.aex")
            ...
            if os.path.exists(system.home+"/sparkz"):
              ...
              os.system("git clone https://github.com/sparkz-technology/sparkz.git "+system.home+"/sparkz")
            if os.path.exists(system.home+"/sparkz/install.aex"):
              os.system("cd "+system.home+"/sparkz && sh install.aex")
              if os.path.exists(system.bin+"/sparkz") and os.path.exists(system.conf_dir+"/sparkz"):
                os.system("clear")
                logo.updated()
                cmd=input("\033[1;36m ##> \033[00m")
  ...
  def menu(self):
    while True:
      ...
      if cmd == "1":
        ...
        logo.exit()
        break
      elif cmd=="rm -t" or cmd=="rm -T" or cmd=="uninstall sparkz" or cmd=="unistall sparkz":
        if system.sudo:
          os.system(system.sudo+" rm -rf "+system.bin+"/sparkz")
          os.system(system.sudo+" rm -rf "+system.bin+"/sparkz")
          os.system(system.sudo+" rm -rf "+system.conf_dir+"/sparkz")
        else:
          os.system("rm -rf "+system.bin+"/sparkz")
          os.system("rm -rf "+system.bin+"/sparkz")
          os.system("rm -rf "+system.conf_dir+"/sparkz")
        os.system("clear")
        logo.exit()
        break
      else:
...
class tools:
  ...
  def __init__(self):
    system=sys()
    with open(system.conf_dir+"/sparkz/core/data.json") as data_file:
      self.data=json.load(data_file)
    with open(system.conf_dir+"/sparkz/core/cat.json") as cat_file:
